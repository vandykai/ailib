...
def parse_loss(
    ...
    Examples::
        >>> from torch import nn
        >>> from ailib.tools.utils_name_parse import parse_loss
...
def _parse_metric(
    ...
    :param Metrix: Base Metric class. Either
        :class:`ailib.metrics.base_metric.RankingMetric` or
        :class:`ailib.metrics.base_metric.ClassificationMetric`.
...
def parse_metric(
    ...
    Examples::
        ...
        >>> from ailib.tools.utils_name_parse import parse_metric

    Use `str` as ailib metrics:
        >>> metric = parse_metric('map', 'ranking')
        >>> type(metric)
        <class 'ailib.metrics.metric_rank.mean_average_precision.MeanAveragePrecision'>

    Use :class:`ailib.metrics.basic_metric.BaseMetric` subclasses as ailib metrics:
        >>> type(parse_metric(metrics.AveragePrecision, 'ranking'))
        <class 'ailib.metrics.metric_rank.average_precision.AveragePrecision'>

    Use :class:`ailib.metrics.basic_metric.BaseMetric` instances as MatchZoo metrics:
        >>> type(parse_metric(metrics.AveragePrecision(), 'ranking'))
        <class 'ailib.metrics.metric_rank.average_precision.AveragePrecision'>
