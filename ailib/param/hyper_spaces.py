...
class HyperoptProxy(object):
    ...
    Reason of these wrappers:
        ...
        sampled. Hyper spaces are used in
        :class:`Param`. Only if a hyper space's label
        matches its parent :class:`Param`'s name, It
