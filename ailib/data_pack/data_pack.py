"""DataPack, pair-wise tuple (feature) and context as input."""
...
class DataPack(object):
    """
    class:`DataPack` data structure, store dataframe and context.

    A `DataPack` consists of three parts:
