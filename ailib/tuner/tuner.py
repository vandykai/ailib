...
class Tuner(object):
    ...
    def tune(self):
        ...
        return {
            'best': trials.best_trial['result']['tune_result'],
            'trials': [trial['result']['tune_result'] for trial in trials.trials]
        }
    ...
    def _run(self, sample):
        ...
        model = self._model_class(params.to_config())
        ...
        return {
            ...
            # this item is for storing tune information
    ...
    def _validate_params(cls, params):
        if not isinstance(params, ParamTable):
    ...
    def _validate_dataloader(cls, data):
        if not isinstance(data, Iterable):
            raise TypeError(
                "Only accepts a `Iterable` instance.")
